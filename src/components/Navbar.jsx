...
function Navbar() {
    return (
        <nav className="flex items-center justify-between px-4 py-5 font-poppins lg:container sm:px-6 sm:py-8 md:py-7 lg:px-4 lg:py-9">
            ...
            <div className="flex gap-5">
                <button className="hidden rounded-lg border border-gray-300 px-2.5 py-2 text-sm text-gray-500 outline-none hover:border-gray-400 lg:inline">
                    Log in
                </button>
                <button className="hidden rounded-lg border border-none bg-black px-3 py-2 text-sm font-semibold text-white outline-none lg:inline">
                    Download
                </button>
                ...
                <div className="lg:hidden">
                    <Popover>
                        {({ open }) => (
                            <>
                                <PopoverButton className="text-black outline-none hover:bg-gray-100 p-2 rounded-lg">
                                    {open ? (
                                        <svg
                                ...
                                <PopoverPanel
                                    ...
                                    transition
                                    className="flex w-full origin-top z-50 flex-col gap-4 rounded-2xl bg-gray-50 px-4 pb-4 pt-8 transition duration-200 ease-out data-[closed]:scale-95 data-[closed]:opacity-0 sm:px-6"
                                >
                                    <a
                                        href="#"
                                    ...
                                    <a
                                        href="#"
                                        className="mt-3 rounded-lg border border-gray-300 px-2.5 py-2 text-center text-base text-gray-500 outline-none hover:border-gray-400"
                                    >
                                        Log in
                                    </a>
                                    <a
                                        href="#"
                                        className="rounded-lg border border-none bg-black px-3 py-2 text-center text-base font-semibold text-white outline-none"
                                    >
                                        Download the app
                                    </a>
                                </PopoverPanel>
